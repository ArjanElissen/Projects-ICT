    ...
    Notification.requestPermission().then(function(result) {
        ...
        if (result === "granted") {
            ...
            navigator.serviceWorker.ready.then(function(serviceworker) { //When the Service Worker is ready, generate the subscription with our Serice Worker's pushManager and save it to our list
                const VAPIDPublicKey = "BC0tyFzQ9XOzkba4Vouz7kxDUKCcQ5mKuCqqJ9kMQmnoGH-JVvNWUfzqAw1cSDDA3n8Ykb7wA5_TdEOC3bhng1w"; // Fill in your VAPID publicKey here
...
document.getElementById("button").addEventListener("click", function() { //Recognize the install variable from before?
